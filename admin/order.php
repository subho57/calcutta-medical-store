...
define('r_key', $fset['r_key']);
define('r_hash', $fset['r_hash']);
?>
                                            ...
                                            <form class="form" method="post" enctype="multipart/form-data">
                                                <div class="form-body">
                                                    ...
                                                    <div class="form-actions">
                                                        ...
                                                        <button type="submit" name="as_order"
                                            ...
                                            <table class="table table-striped" id="example">
                                                ...
                                                while ($row = $sel->fetch_assoc()) {
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><?php $rdata = $con->query("select * from rider where id=" . $row['rid'] . "")->fetch_assoc();
                                                            if ($rdata['name'] == '') {
                                                                echo '';
                                                            } else {
                                                                echo $rdata['name'];
                                                        ...
                                                        <td>
                                                            <button class="preview_d btn btn-primary shadow-z-2"
                                                        ...
                                                        <td>
                                                            <?php if ($row['p_method'] != 'Pickup Myself') { ?>
                                                                <?php if ($row['a_status'] == 0) {
                                                                    ...
                                                                    <a href="?oid=<?php echo $row['id']; ?>">
                                                                        <button class="btn shadow-z-2 btn-info">Assign
                                                                            Delivery Boy
                                                                        </button>
                                                                    </a>
                                                                <?php } else if ($row['a_status'] == 1) {
                                                                    ...
                                                                    <a href="?oid=<?php echo $row['id']; ?>">
                                                                        <button class="btn shadow-z-2 btn-info">Reassign
                                                                            Delivery Boy
                                                                        </button>
                                                                    </a>
                                                        ...
                                                        <td>
                                                            ...
                                                            <?php if ($row['p_method'] == 'Pickup Myself' and $row['status'] != 'completed' and $row['status'] != 'cancelled') { ?>
                                                                <a href="?status=completed&id=<?php echo $row['id']; ?>">
                                                                    <button class="btn shadow-z-2 btn-success">Make
                                                                        Completed
                                                                    </button>
                                                                </a>
                                                            <?php } ?>
