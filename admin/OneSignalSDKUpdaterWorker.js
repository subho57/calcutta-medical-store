!(function (e) {
    ...
    function (e, t, i) {
      ...
      ((S = m || (m = {})).WorkerA = "Worker A (Main)"),
        (S.WorkerB = "Worker B (Updater)"),
    ...
    function (e, t, i) {
      ...
      class N {
        ...
        getRegistration() {
          return Object(c.a)(this, void 0, void 0, function* () {
            return yield x.a.getRegistration(
        ...
        getActiveState() {
          return Object(c.a)(this, void 0, void 0, function* () {
            ...
            const i = N.activeSwFileName(t);
            return this.swActiveStateByFileName(i);
          });
        }
        static activeSwFileName(e) {
          const t = x.a.getAvailableServiceWorker(e);
          if (!t) return null;
              ...
              Object(c.a)(this, void 0, void 0, function* () {
                if (d.b.isUsingSubscriptionWorkaround()) {
                  ...
                  this.context.workerMessenger.once(o.b.WorkerVersion, (t) => {
                    ...
                    this.context.workerMessenger.unicast(o.b.WorkerVersion);
              })
            );
          });
        }
        ...
        haveParamsChanged() {
          return Object(c.a)(this, void 0, void 0, function* () {
            ...
            const n = x.a.getAvailableServiceWorker(e),
              o = E.b.getPossibleServiceWorkerHrefs(
                this.config,
        ...
        workerNeedsUpdate() {
          return Object(c.a)(this, void 0, void 0, function* () {
            ...
            try {
              e = yield A.a.timeoutPromise(this.getWorkerVersion(), 2e3);
            } catch (e) {
              return (
                a.a.info(
          ...
          return Object(c.a)(this, void 0, void 0, function* () {
            ...
            e.on(o.b.AreYouVisible, (n) => {
              if (t && i) {
                ...
                e.directPostMessageToSW(o.b.AreYouVisibleResponse, t);
              } else {
        ...
        installAlternatingWorker() {
          return Object(c.a)(this, void 0, void 0, function* () {
            ...
            const t = E.b.getAlternatingServiceWorkerHref(
                e,
                this.config,
                this.context.appConfig.appId
              ),
              i = `${d.b.getBaseUrl()}${this.config.registrationOptions.scope}`;
            a.a.info(
      ...
      class K {
        ...
        unsubscribe(e) {
          return Object(c.a)(this, void 0, void 0, function* () {
            ...
            if (s.a.getWindowEnv() !== r.a.ServiceWorker) throw new w.a();
            {
              ...
              yield W.a.updatePlayer(this.context.appConfig.appId, e, {
        ...
        associateSubscriptionWithEmail(e) {
          return Object(c.a)(this, void 0, void 0, function* () {
            ...
            t.subscriptionId &&
              (yield W.a.updatePlayer(this.config.appId, e, {
                parent_player_id: t.subscriptionId,
                email: t.identifier,
              }));
          });
        ...
        subscribeWithVapidKey(e, t) {
          return Object(c.a)(this, void 0, void 0, function* () {
            ...
            const s = U.a.setFromW3cSubscription(n);
            return (
              i &&
                (s.existingW3cPushSubscription = U.a.setFromW3cSubscription(i)),
              s
            );
          });
        }
        ...
        isSubscriptionExpiringForSecureIntegration() {
          return Object(c.a)(this, void 0, void 0, function* () {
            ...
            let { createdAt: n } = yield y.a.getSubscription();
            if (!n) {
              const e = 31536e6;
      ...
      var G = class {
          static getServiceWorkerManager(e) {
            const t = e.appConfig,
              ...
              n = {
                workerAPath: new S(`/${i}OneSignalSDKWorker.js`),
                workerBPath: new S(`/${i}OneSignalSDKUpdaterWorker.js`),
      ...
      class oe {
        ...
        static getRawPushSubscriptionFromServiceWorkerRegistration(e) {
          return Object(c.a)(this, void 0, void 0, function* () {
            ...
            return t ? U.a.setFromW3cSubscription(t) : null;
          });
        }
      ...
      class se {
        ...
        static getSlidedownOptions(e) {
          return A.a.getValueOrDefault(e.slidedown, { prompts: [] });
        }
      ...
      class ae {
        ...
        sendPlayerCreate(e) {
          return Object(c.a)(this, void 0, void 0, function* () {
            ...
            try {
              const t = yield W.a.createUser(e);
              return t
                ? (a.a.info(
        ...
        sendExternalUserIdUpdate(e, t) {
          return Object(c.a)(this, void 0, void 0, function* () {
            ...
            const i = {
              external_user_id: A.b.getValueOrDefault(e, ""),
              external_user_id_auth_hash: A.b.getValueOrDefault(t, void 0),
            };
        ...
        sendPushPlayerUpdate(e) {
          return Object(c.a)(this, void 0, void 0, function* () {
            ...
            if (
              ...
              return yield W.a.updatePlayer(this.context.appConfig.appId, t, e);
          });
        }
        sendOutcomeDirect(e, t, i, n) {
          return Object(c.a)(this, void 0, void 0, function* () {
            ...
            void 0 !== n && (s.weight = n), yield W.a.sendOutcome(s);
          });
        }
        ...
        sendOutcomeUnattributed(e, t, i) {
          return Object(c.a)(this, void 0, void 0, function* () {
            ...
            void 0 !== i && (o.weight = i), yield W.a.sendOutcome(o);
          });
        }
      }
      class ce {
    ...
    function (e, t, i) {
        ...
        setIdentifier(e, t) {
          return Object(n.a)(this, void 0, void 0, function* () {
            ...
            if (n.subscriptionId)
              ...
              (t.appId = i.appId),
                yield b.a.addExternalUserIdToDeviceRecord(t),
      ...
      class I {
        ...
        sendOnFocus(e) {
          return Object(n.a)(this, void 0, void 0, function* () {
            ...
            yield P.b.post(`players/${t.subscriptionId}/on_focus`, i);
          });
        }
      }
      class k {
      ...
      class A extends E {
        constructor() {
          super(...arguments), (this.deviceType = C.a.Email);
        }
        newProfile(e, t, i) {
      ...
      class N extends E {
        constructor() {
          super(...arguments), (this.deviceType = C.a.SMS);
        }
        newProfile(e, t, i) {
        ...
        logout() {
          return Object(n.a)(this, void 0, void 0, function* () {
            return (yield f.a.getSMSProfile()).subscriptionId
              ? (yield f.a.setSMSProfile(new x.a()), !0)
              : (s.a.warn(
      ...
      class M {
        constructor() {
          ...
          const e = new A(),
            t = new h(new y(e), new w(e), new O(e), new k(e), new I(e));
          (this.email = t), this.synchronizer.registerChannel(t);
          const i = new N(),
            n = new T(new y(i), new w(i), new O(i), new k(i), new I(i));
                ...
                Object(n.a)(this, void 0, void 0, function* () {
                  ...
                  if (e) {
                    const t = yield self.registration.pushManager.permissionState(
                      ...
                      n = !!e && "granted" === t && !0 !== i;
                    k.workerMessenger.broadcast(a.b.AmpSubscriptionState, n);
                  } else k.workerMessenger.broadcast(a.b.AmpSubscriptionState, !1);
                })
              ),
