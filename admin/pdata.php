...
?>
<input type='button' id='btn' class="btn btn-primary text-right" value='Print' onclick='printDiv();'
       style="float:right;">
<div id="divprint">
    ...
    <ul class="list-group">
        ...
        <li class="list-group-item">
            <span class="badge bg-info float-right budge-own"><?php echo $c['total'] - (($subtotal + $tax) - ($coupon + $wallet)); ?></span>
            Delivery Charge
        </li>
