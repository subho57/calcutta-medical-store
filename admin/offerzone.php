...
{
    $content = array(
        "en" => $title . ' is on offer now. Special DISCOUNTS!! 🤩🤩 Grab it before it expires.'
    );
    $heading = array(
        "en" => 'LIMITED OFFER!! 🎁 🎁'
    );
                ...
                <div class="content-wrapper">
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title" id="basic-layout-form">Add Offer SubCategory</h4>
                                </div>
                                <div class="card-body">
                                    <div class="px-3">
                                        <form class="form" method="post" enctype="multipart/form-data">
                                            <div class="form-body">
                                                ...
                                                <div class="form-group">
                                                    <label for="cname">Offer SubCategory Name</label>
                                                ...
                                                <div class="form-group">
                                                    <label>Offer SubCategory Image</label>
                                            ...
                                            <div class="form-actions">
                                                ...
                                                <button type="submit" name="sub_cat" class="btn btn-raised btn-raised btn-primary">
                                                    <i class="fa fa-check-square-o"></i> Save Offer Subcategory
                                                </button>
                                            </div>
                                            ...
                                            ?>
                                                ...
                                                <script type="text/javascript">
                                                    $(document).ready(function() {
                                                        ...
                                                        toastr.info('Offer SubCategory Inserted Successfully!!');
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title" id="basic-layout-form">Add Offer Product</h4>
                                    ...
                                    <div class="px-3">
                                        <form class="form" action="#" method="post" enctype="multipart/form-data">
                                            <div class="form-body">
                                                ...
                                                <div class="form-group">
                                                    <label for="projectinput6">Select Offer Subcategory</label>
                                            ...
                                            <div class="form-actions">
                                                ...
                                                <button type="submit" name="sub_product" class="btn btn-raised btn-raised btn-primary">
                                                    <i class="fa fa-check-square-o"></i> Save Offer Product
                                                </button>
                                            </div>
                                        </form>
                                    </div>
                        ...
                        ?>
                                <script type="text/javascript">
                                    $(document).ready(function() {
                                        ...
                                        toastr.error('Insert at max 3 Images only!!.');
                                        setTimeout(function() {
                            ...
                            ?>
                                <script type="text/javascript">
                                    $(document).ready(function() {
                                        toastr.options.timeOut = 4500; // 1.5s
                                        toastr.info('Offer Product Inserted Successfully!!');
