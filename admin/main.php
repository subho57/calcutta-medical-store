<div data-active-color="white" data-background-color="purple-bliss" data-image="" class="app-sidebar">
    ...
    <div class="sidebar-header">
        <div class="logo clearfix"><a href="dashboard.php" class="logo-text float-left">
                <div class="logo-img"><img src="<?php echo $fset['logo']; ?>" style="width:300%;"/></div>
    ...
    <div class="sidebar-content">
        <div class="nav-container">
            <ul id="main-menu-navigation" data-menu="menu-navigation" class="navigation navigation-main">
                <li><a href="dashboard.php"><i class="ft-airplay"></i><span data-i18n=""
                ...
                <li class="has-sub nav-item"><a href="#"><i class="ft-compass"></i><span data-i18n=""
                                                                                         class="menu-title">Area</span></a>
                    <ul class="menu-content">
                ...
                <li class="has-sub nav-item"><a href="#"><i class="fa fa-motorcycle"></i><span data-i18n=""
                                                                                               class="menu-title">Delivery Boy</span></a>
                    <ul class="menu-content">
                ...
                <li class="has-sub nav-item"><a href="#"><i class="ft-image"></i><span data-i18n="" class="menu-title">Banner 2</span></a>
                    <ul class="menu-content">
                        <li><a href="new_banner.php" class="menu-item">Add 2nd Banner</a>
                        </li>
                        <li><a href="new_bannerlist.php" class="menu-item">2nd Banner List</a>
                        </li>
                    </ul>
                </li>
                ...
                <li class="has-sub nav-item"><a href="#"><i class="ft-bell"></i><span data-i18n="" class="menu-title">Notification</span></a>
                    <ul class="menu-content">
                        <li><a href="notification.php" class="menu-item">Add Notification</a>
                        </li>
                        <li><a href="notificationlist.php" class="menu-item">Notification List</a>
                        </li>
                    </ul>
                </li>
                ...
                <li class="has-sub nav-item"><a href="#"><i class="ft-users"></i><span data-i18n="" class="menu-title">Customer Section</span></a>
                    <ul class="menu-content">
                        <li><a href="user.php" class="menu-item">Customer List</a>
                        </li>
                        <li><a href="userexport.php" class="menu-item">Export User Data</a>
                        </li>
                        <li><a href="orderrate.php" class="menu-item">Customer Ratings</a>
                        </li>
                        <li><a href="feed.php" class="menu-item">Feedbacks</a>
                        </li>
                    </ul>
                </li>

                <li class="has-sub nav-item"><a href="#"><i class="fa fa-flag"></i><span data-i18n=""
                                                                                         class="menu-title"> Country Code</span></a>
                    <ul class="menu-content">
                ...
                <li><a href="paymentlist.php"><i class="fa fa-money"></i><span data-i18n="" class="menu-title">Payment
                            List</span></a></li>
                <li><a href="profile.php"><i class="ft-user"></i><span data-i18n=""
            ...
            <div id="navbarSupportedContent" class="collapse navbar-collapse">
                <ul class="navbar-nav">
                    <li class="nav-item mr-2 d-none d-lg-block"><a id="navbar-fullscreen" href="javascript:;"
                        ...
                        <li class="dropdown nav-item"><a id="dropdownBasic3" title="Logout" href="logout.php" class="nav-link position-relative"><i class="fa fa-sign-out font-medium-3 blue-grey darken-4"></i>
