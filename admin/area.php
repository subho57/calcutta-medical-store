                                        ...
                                        <form class="form" method="post" enctype="multipart/form-data">
                                            <div class="form-body">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" id="aname" value="<?php echo $sels['name']; ?>"
                                                           class="form-control" name="cname" required>
                                                </div>

                                                <div class="form-group">
                                                    <label for="cname">Delivery Charge(Only Digit)</label>
                                                    <input type="number" id="dcharge"
                                                           value="<?php echo $sels['dcharge']; ?>" class="form-control"
                                                           name="dcharge" step="any" required>
                                                </div>
                                            ...
                                            <div class="form-actions">
                                                ...
                                                <button type="submit" name="up_cat"
                                    ...
                                    <div class="px-3">
                                        <form class="form" method="post" enctype="multipart/form-data">
                                            <div class="form-body">
                                                ...
                                                <div class="form-group">
                                                    <label for="cname">Area Name</label>
                                                    <input type="text" id="aname" class="form-control" name="cname"
                                                           required>
                                                </div>

                                                <div class="form-group">
                                                    <label for="cname">Delivery Charge(Only Digit)</label>
                                                    <input type="text" id="dcharge" class="form-control"
                                                           pattern="[0-9]+" name="dcharge" required>
                                                </div>
