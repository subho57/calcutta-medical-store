											...
											<form class="form" method="post" enctype="multipart/form-data">
													...
													<div class="row">
															...
															<div class="form-group">
																...
																<div class="row">
																	<div class="col-md-8 col-lg-8 col-xs-12 col-sm-12">
																		<input type="text" id="ccode" value="<?php echo $sels['c_title']; ?>" class="form-control" onkeypress="return isNumberKey(event)" maxlength="8" name="ccode" oninput="this.value = this.value.toUpperCase()" required>
																	</div>
														...
														<div class="col-md-3 col-lg-3 col-xs-12 col-sm-12">
															<div class="form-group">
																...
																<select name="cstatus" class="form-control" required>
																	...
																	<option value="1" <?php if ($sels['status'] == 1) {
																							echo 'selected';
																						} ?>>Publish</option>
																	<option value="0" <?php if ($sels['status'] == 0) {
																							echo 'selected';
																						} ?>>Unpublish</option>
														...
														<div class="col-md-3 col-lg-3 col-xs-12 col-sm-12">
															...
															<div class="form-group">
																...
																<input type="number" id="cname" value="<?php echo $sels['min_amt']; ?>" class="form-control" name="minamt" step="1" onkeypress="return event.charCode >= 48 && event.charCode <= 57" required>
															</div>
														</div>
														<div class="col-md-3 col-lg-3 col-xs-12 col-sm-12">
															...
															<div class="form-group">
																...
																<input type="number" id="cname" value="<?php echo $sels['min_quan']; ?>" class="form-control" name="minquan" step="1" onkeypress="return event.charCode >= 48 && event.charCode <= 57" required>
															</div>
														</div>
														...
														<div class="col-md-3 col-lg-3 col-xs-12 col-sm-12">
															<div class="form-group">
																...
																<input type="number" id="cname" class="form-control" value="<?php echo $sels['c_value']; ?>" name="cvalue" step="1" onkeypress="return event.charCode >= 48 && event.charCode <= 57" required>
															</div>
														</div>
												...
												<div class="form-actions">
													...
													<button type="submit" name="up_cat" class="btn btn-raised btn-raised btn-primary">
														<i class="fa fa-check-square-o"></i> Save Coupon
													</button>
												</div>
												...
												if (isset($_POST['up_cat'])) {
													...
													if (!empty($_FILES["f_up"]["name"])) {
														...
														$con->query("update tbl_coupon set c_title='" . $ccode . "',c_img='" . $url . "',min_amt=" . $minamt .  ",min_quan=" . $minquan . ",ctitle='" . $ctitle . "',cdate='" . $cdate . "',c_value=" . $cvalue . ",status=" . $cstatus . ",c_desc='" . $cdesc . "' where id=" . $_GET['edit'] . "");
													} else {
														$con->query("update tbl_coupon set c_title='" . $ccode . "',ctitle='" . $ctitle . "',min_amt=" . $minamt .  ",min_quan=" . $minquan . ",cdate='" . $cdate . "',c_value=" . $cvalue . ",status=" . $cstatus . ",c_desc='" . $cdesc . "' where id=" . $_GET['edit'] . "");
													}
												?>
					...
					<?php } else { ?>
						<div class="row">
							<div class="col-md-12">
								<div class="card">
									<div class="card-header">
										<h4 class="card-title" id="basic-layout-form">Add New Coupon</h4>
												...
												<div class="form-body">
													...
													<div class="row">
														...
														<div class="col-md-3 col-lg-3 col-xs-12 col-sm-12">
															...
															<div class="form-group">
																<label>Min Order Quantity</label>
																<input type="number" id="cname" class="form-control" name="minquan" step="1" onkeypress="return event.charCode >= 48 && event.charCode <= 57" required>
															</div>
														</div>
													...
													?>
														...
														<script type="text/javascript">
															$(document).ready(function() {
																...
																toastr.info('Coupon Code Inserted Successfully!!!');
