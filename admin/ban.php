				...
				<div class="content-wrapper">
					...
					<div class="row">
									...
									<div class="px-3">
										...
										?>
											...
											if (isset($_POST['edit_product'])) {
												...
												if ($_FILES["pimg"]["name"] == '') {
													$con->query("update banner set cid=" . $cid . ",sid=" . $sid . " where id=" . $_GET['edit'] . "");
											...
											?>
													...
													<?php
														...
														$con->query("update banner set cid=" . $cid . ",sid=" . $sid . ",bimg='" . $target_file . "' where id=" . $_GET['edit'] . "");
						...
						if (isset($_POST['sub_product'])) {
							...
							$cid = $_POST['cat'];
							$sid = $_POST['scat'];
							$con->query("insert into banner(`bimg`,`cid`,`sid`)values('" . $url . "'," . $cid . "," . $sid . ")");
							move_uploaded_file($_FILES["pimg"]["tmp_name"], $target_file);
						?>
							<script type="text/javascript">
								$(document).ready(function() {
