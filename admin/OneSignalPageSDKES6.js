  ...
  function (e, t, i) {
    ...
    class x {
      static isCategorySlidedownConfigured(e) {
        if (!e) return !1;
        const t = x.getFirstSlidedownPromptOptionsWithType(e, T.Category);
    ...
    class _ {
      ...
      getReportedNotificationPermission(e) {
        return Object(d.a)(this, void 0, void 0, function* () {
          if (g.a.safari) return _.getSafariNotificationPermission(e);
    ...
    const W = {
      ...
      K = { greyLoadingIndicator: "#95A1AC", whiteLoadingIndicator: "#FFFFFF" },
      q = { fetchingPreferences: "Fetching your preferences" },
      Y = {
    ...
    class ee {
          ...
          if (
            ...
            if (
              ...
              (null === (t = this.config) || void 0 === t
                ? void 0
                : t.unsubscribeEnabled) || !(yield ee.isPushEnabled()))
            )
      ...
      static isOptedOut() {
        return Object(d.a)(this, void 0, void 0, function* () {
          return yield OneSignal.internalIsOptedOut();
        });
      }
    }
    class te {
        ...
        return Object(d.a)(this, void 0, void 0, function* () {
          ...
          const n =
            null ===
              ...
              ? void 0
              : i.prompts;
          x.isCategorySlidedownConfigured(n) &&
      ...
      static onSubscriptionChanged_showWelcomeNotification(e) {
        return Object(d.a)(this, void 0, void 0, function* () {
          if (OneSignal.__doNotShowWelcomeNotification)
            ...
            (o = k.a.decodeHtmlEntities(o)),
              (s = k.a.decodeHtmlEntities(s)),
              n ||
    ...
    class xe {
      ...
      show() {
        return this.hidden
          ? new Promise((e) => {
              (this.state = "showing"), S.a.trigger(xe.EVENTS.SHOWING, this);
                ...
                (t, n) => {
                  if (
                    ...
                    return (
                      ...
                      n(),
                      (this.state = "shown"),
                      S.a.trigger(xe.EVENTS.SHOWN, this),
                      e(this)
                    );
                },
                !0
      ...
      hide() {
        return this.shown
          ? new Promise((e) => {
              (this.state = "hiding"), S.a.trigger(xe.EVENTS.HIDING, this);
              const t = this.element;
              if (
                (t
                ...
                (t, i) => {
                  ...
                  if (
                    ...
                    return (
                      ...
                      i(),
                      (this.state = "hidden"),
                      S.a.trigger(xe.EVENTS.HIDDEN, this),
                      e(this)
                    );
                },
                !0
      ...
      waitUntilShown() {
        return "shown" === this.state
          ? Promise.resolve(this)
          : new Promise((e) => {
              Bi.emitter.once(xe.EVENTS.SHOWN, (t) => {
      ...
      waitUntilHidden() {
        return "hidden" === this.state
          ? Promise.resolve(this)
          : new Promise((e) => {
              Bi.emitter.once(xe.EVENTS.HIDDEN, (t) => {
                if (t === this) return e(this);
              });
            });
      }
    ...
    class _e extends xe {
        ...
        return this.inactive && this.shown
          ? new Promise((e) => {
              (this.activeState = "activating"),
                S.a.trigger(_e.EVENTS.ACTIVATING, this);
              const t = this.element;
              if (
                (t
                ...
                return (
                  ...
                  S.a.trigger(_e.EVENTS.ACTIVE, this),
                  e(this)
                );
        ...
        return this.active
          ? new Promise((e) => {
              (this.activeState = "inactivating"),
                S.a.trigger(_e.EVENTS.INACTIVATING, this);
              const t = this.element;
              if (
                (t
                ...
                return (
                  ...
                  S.a.trigger(_e.EVENTS.INACTIVE, this),
                  e(this)
                );
              if (0 == this.targetTransitionEvents.length) return e(this);
              var i = setTimeout(() => {
      ...
      waitUntilActive() {
        return this.active
          ? Promise.resolve(this)
          : new Promise((e) => {
              Bi.emitter.once(_e.EVENTS.ACTIVE, (t) => {
                if (t === this) return e(this);
              });
            });
      }
      waitUntilInactive() {
        return this.inactive
          ? Promise.resolve(this)
          : new Promise((e) => {
              Bi.emitter.once(_e.EVENTS.INACTIVE, (t) => {
                if (t === this) return e(this);
              });
            });
      }
      static get EVENTS() {
        return Object.assign(Object.assign({}, xe.EVENTS), {
    ...
    class De extends xe {
      ...
      getTipForState() {
        return this.bell.state === qe.STATES.UNSUBSCRIBED
          ? this.bell.options.text["tip.state.unsubscribed"]
          : this.bell.state === qe.STATES.SUBSCRIBED
          ? this.bell.options.text["tip.state.subscribed"]
          : this.bell.state === qe.STATES.BLOCKED
    ...
    class Re extends _e {
      ...
      onHovering() {
        (v.isEmpty(this.events.mouse) ||
          ...
          S.a.trigger(qe.EVENTS.HOVERING),
          v.put(this.events.mouse, "over");
      }
      onHovered() {
        v.put(this.events.mouse, "out"), S.a.trigger(qe.EVENTS.HOVERED);
      }
      onTap() {
      ...
      onClick() {
        if (
          (S.a.trigger(qe.EVENTS.BELL_CLICK),
          S.a.trigger(qe.EVENTS.LAUNCHER_CLICK),
      ...
      updateBellLauncherDialogBody() {
        return OneSignal.getSubscription().then((e) => {
          ...
          if (
            ...
            (this.bell.state === qe.STATES.SUBSCRIBED && !0 === e) ||
              (this.bell.state === qe.STATES.UNSUBSCRIBED && !1 === e))
          ) {
            let e = "";
          ...
          } else if (this.bell.state === qe.STATES.BLOCKED) {
            let e = null;
            g.a.chrome
            ...
            this.subscribeButton &&
              this.subscribeButton.addEventListener("click", () => {
                (OneSignal.__doNotShowWelcomeNotification = !1),
                  S.a.trigger(qe.EVENTS.SUBSCRIBE_CLICK);
              }),
            this.unsubscribeButton &&
              this.unsubscribeButton.addEventListener("click", () =>
                S.a.trigger(qe.EVENTS.UNSUBSCRIBE_CLICK)
              ),
            this.bell.setCustomColorsIfSpecified();
        });
      }
    ...
    class qe {
      constructor(e, t) {
        (this.state = qe.STATES.UNINITIALIZED),
      ...
      installEventHooks() {
        Bi.emitter.on(qe.EVENTS.SUBSCRIBE_CLICK, () => {
          ...
          Bi.emitter.on(qe.EVENTS.UNSUBSCRIBE_CLICK, () => {
          ...
          Bi.emitter.on(qe.EVENTS.HOVERING, () => {
            (this.hovering = !0),
          ...
          Bi.emitter.on(qe.EVENTS.HOVERED, () => {
            this.message.contentType !== De.TYPES.MESSAGE &&
              this.dialog.hidden &&
              (this.hovering &&
                ((this.hovering = !1),
          ...
          Bi.emitter.on(Bi.EVENTS.SUBSCRIPTION_CHANGED, (e) =>
            Object(d.a)(this, void 0, void 0, function* () {
              ...
              Bi.getNotificationPermission((t) => {
                let i;
                (i = e
                  ? qe.STATES.SUBSCRIBED
                  : t === A.Denied
                  ? qe.STATES.BLOCKED
                  : qe.STATES.UNSUBSCRIBED),
                  this.setState(i, this._ignoreSubscriptionState);
              });
            })
          ),
          Bi.emitter.on(qe.EVENTS.STATE_CHANGED, (e) => {
            this.launcher.element &&
              (e.to === qe.STATES.SUBSCRIBED
                ? this.launcher.inactivate()
                : (e.to === qe.STATES.UNSUBSCRIBED || qe.STATES.BLOCKED) &&
      ...
      create() {
        return Object(d.a)(this, void 0, void 0, function* () {
          ...
          this.container && Object(X.w)("#onesignal-bell-container"),
            ...
            Object(X.b)(this.button.selector, "beforeend", Ke);
      ...
      updateState() {
        Promise.all([
          ...
          this.setState(e ? qe.STATES.SUBSCRIBED : qe.STATES.UNSUBSCRIBED),
            t === A.Denied && this.setState(qe.STATES.BLOCKED);
        });
      }
      setState(e, t = !1) {
        const i = this.state;
        (this.state = e),
          i === e ||
            t ||
            S.a.trigger(qe.EVENTS.STATE_CHANGED, { from: i, to: e });
      }
      get container() {
      ...
      get badge() {
        return this._badge || (this._badge = new je()), this._badge;
      }
      get message() {
      ...
      get subscribed() {
        return this.state === qe.STATES.SUBSCRIBED;
      }
      get unsubscribed() {
        return this.state === qe.STATES.UNSUBSCRIBED;
      }
      get blocked() {
        return this.state === qe.STATES.BLOCKED;
      }
    }
    class Ye {
      constructor(e, t) {
        ...
        return Object(d.a)(this, void 0, void 0, function* () {
          ...
          if (N.a.isUsingSubscriptionWorkaround())
            return e.httpPermissionRequest
              ? void E.a.error(new it(ze.HttpPermissionRequest))
      ...
      static installNativePromptPermissionChangedHook() {
        return Object(d.a)(this, void 0, void 0, function* () {
          if (
            ...
            !(g.a.firefox && Number(g.a.version) <= 45)
          ) {
    ...
    class Pt {
      ...
      setIdentifier(e, t) {
        return Object(d.a)(this, void 0, void 0, function* () {
          ...
          return (
            o.subscriptionId && (yield this.profileProvider.setProfile(o)),
            o.subscriptionId
          );
        });
      }
    ...
    class Wt {
      ...
      setIdentifier(e, t) {
        return Object(d.a)(this, void 0, void 0, function* () {
          return yield this.secondaryChannelIdentifierUpdater.setIdentifier(
            e,
            t
          );
        });
    ...
    class Vt {
      static getAlternatingServiceWorkerHref(e, t, i) {
        let n;
        return (
          (n =
            e === xt.WorkerA
              ? t.workerBPath.getFullPath()
              : t.workerAPath.getFullPath()),
          Vt.appendServiceWorkerParams(n, i)
        );
      }
      static getPossibleServiceWorkerHrefs(e, t) {
        return [e.workerAPath.getFullPath(), e.workerBPath.getFullPath()].map(
          (e) => Vt.appendServiceWorkerParams(e, t)
        );
      }
      static appendServiceWorkerParams(e, t) {
        return `${
          new URL(e, N.a.getBaseUrl()).href
        }?${w.b.encodeHashAsUriComponent({ appId: t })}`;
      }
    ...
    ((_t = xt || (xt = {})).WorkerA = "Worker A (Main)"),
      (_t.WorkerB = "Worker B (Updater)"),
      (_t.ThirdParty = "3rd Party"),
      (_t.None = "None"),
      (_t.Indeterminate = "Indeterminate");
    class Lt {
      constructor(e, t) {
      ...
      getActiveState() {
        return Object(d.a)(this, void 0, void 0, function* () {
          ...
          if (e === Ne.a.InsecureProxy) return xt.Indeterminate;
            ...
            Object(d.a)(this, void 0, void 0, function* () {
              if (N.b.isUsingSubscriptionWorkaround()) {
                ...
                this.context.workerMessenger.once(Se.WorkerVersion, (t) => {
                  ...
                  this.context.workerMessenger.unicast(Se.WorkerVersion);
            })
          );
        });
      }
      ...
      haveParamsChanged() {
        return Object(d.a)(this, void 0, void 0, function* () {
          ...
          const n = Ee.getAvailableServiceWorker(e),
            o = Vt.getPossibleServiceWorkerHrefs(
              this.config,
      ...
      installWorker() {
        return Object(d.a)(this, void 0, void 0, function* () {
          (yield this.shouldInstallWorker()) &&
            (yield this.installAlternatingWorker(),
            (yield this.getActiveState()) === xt.WorkerB &&
              (yield this.installAlternatingWorker()),
        ...
        return Object(d.a)(this, void 0, void 0, function* () {
          ...
          e.off(),
            e.on(Se.NotificationDisplayed, (e) => {
              E.a.debug(
                ...
                S.a.trigger(OneSignal.EVENTS.NOTIFICATION_DISPLAYED, e);
            }),
            e.on(Se.NotificationClicked, (e) =>
              Object(d.a)(this, void 0, void 0, function* () {
                ...
                } else S.a.trigger(OneSignal.EVENTS.NOTIFICATION_CLICKED, e);
              })
            ),
            ...
            e.on(Se.NotificationDismissed, (e) => {
              S.a.trigger(OneSignal.EVENTS.NOTIFICATION_DISMISSED, e);
            });
          const t = N.b.isHttps(),
            i = N.b.isSafari();
          e.on(Se.AreYouVisible, (n) => {
            if (t && i) {
              ...
              e.directPostMessageToSW(Se.AreYouVisibleResponse, t);
            } else {
      ...
      installAlternatingWorker() {
        return Object(d.a)(this, void 0, void 0, function* () {
          ...
          const t = Vt.getAlternatingServiceWorkerHref(
              e,
              this.config,
              this.context.appConfig.appId
            ),
    ...
    ((Dt = jt || (jt = {}))[(Dt.InvalidSafariSetup = 0)] =
      "InvalidSafariSetup"),
    ...
    class Ht {
      ...
      subscribeSafari() {
        return Object(d.a)(this, void 0, void 0, function* () {
          ...
          if ((ue.a.triggerNotificationPermissionChanged(), !i))
            throw new Ft(jt.InvalidSafariSetup);
      ...
      isSubscriptionExpiringForSecureIntegration() {
        return Object(d.a)(this, void 0, void 0, function* () {
          ...
          if (e !== xt.WorkerA && e !== xt.WorkerB) return !1;
          const t = yield this.context.serviceWorkerManager.getRegistration();
          if (!t) return !1;
          ...
          let { createdAt: n } = yield M.a.getSubscription();
          if (!n) {
            const e = 31536e6;
    ...
    var $t = class {
      static getServiceWorkerManager(e) {
        const t = e.appConfig,
          ...
          n = {
            workerAPath: new st(`/${i}OneSignalSDKWorker.js`),
            workerBPath: new st(`/${i}OneSignalSDKUpdaterWorker.js`),
            registrationOptions: { scope: "/" },
          };
        return (
          t.userConfig &&
            (t.userConfig.path &&
              ((n.workerAPath = new st(
                `${t.userConfig.path}${t.userConfig.serviceWorkerPath}`
              )),
              (n.workerBPath = new st(
                `${t.userConfig.path}${t.userConfig.serviceWorkerUpdaterPath}`
              ))),
    ...
    const Gt = {
      ...
      Yt = {
        type: T.Push,
        text: {
          actionMessage: qt.actionMessage,
          acceptButton: qt.acceptButton,
          cancelButton: qt.cancelButton,
        },
        autoPrompt: !1,
        delay: Kt,
      };
    ...
    class ci {
      constructor(e) {
        var t, i, n;
        switch (
          ((this.savingButton = qt.savingText),
          (this.errorButton = qt.errorButton),
          (this.options = e),
      ...
      removeFailureState() {
        Object(X.w)("#onesignal-button-indicator-holder"),
          ...
          x.isSlidedownPushDependent(this.options.type) ||
    ...
    class gi {
      ...
      spawnAutoPrompts() {
        return Object(d.a)(this, void 0, void 0, function* () {
          ...
          const c = !!x.getFirstSlidedownPromptOptionsWithType(
        ...
        return Object(d.a)(this, void 0, void 0, function* () {
          ...
          const o =
            ...
            s =
              ...
              x.getFirstSlidedownPromptOptionsWithType(o, e);
          if (!s) {
            if (e !== T.Push)
              return void E.a.error(
      ...
      getDelayedPromptOptions(e, t) {
        ...
        const r = {
          enabled: !1,
          autoPrompt: !1,
          timeDelay: Kt.timeDelay,
          pageViews: Kt.pageViews,
        };
        ...
        switch (t) {
          ...
          case T.SmsAndEmail:
            const { userConfig: c } = this.context.appConfig,
              l = x.getFirstSlidedownPromptOptionsWithType(
                (null ===
                  (n =
    ...
    class bi {
      ...
      load() {
        ...
        Object(X.a)(e, `${W.loadingContainer}`),
          ...
          Object(X.b)(e, "beforeend", Jt(K.greyLoadingIndicator)),
          (i.innerText = q.fetchingPreferences),
          e.appendChild(i),
          (t.disabled = !0);
      }
      generateHtml(e, t) {
        ...
        return Object(d.a)(this, void 0, void 0, function* () {
          ...
          const a =
            null === (t = e.slidedownPromptOptions) || void 0 === t
              ...
              : t.type;
          let c = !1;
          if ((a && (c = x.isSlidedownPushDependent(a)), c)) {
    ...
    class Ei {
      ...
      static convertConfigToVersionTwo(e) {
        var t, i, n, o;
        const s = x.isCategorySlidedownConfiguredVersion1(e)
          ? T.Category
          : T.Push;
        let r, a;
        return (
    ...
    class Pi {
      ...
      static injectDefaultsIntoPromptOptions(e, t, i, n = !1) {
        ...
        return (
          (c.autoPrompt =
            c.native.autoPrompt ||
            x.isSlidedownAutoPromptConfigured(c.slidedown.prompts)),
          c
        );
      }
      static getPromptOptionsForDashboardConfiguration(e) {
        ...
        return {
          autoPrompt: i.autoPrompt || x.isSlidedownAutoPromptConfigured(n),
          native: i,
          slidedown: { prompts: n },
          fullscreen: {
      ...
      load() {
        return Object(d.a)(this, void 0, void 0, function* () {
          ...
          return (
            ...
            (this.element = e),
            Object(X.x)(this.loadPromise.promise, _i.LOAD_TIMEOUT_MS).catch(
              () => {
                window === window.top &&
                  E.a.warn(
    ...
    class ji {
      ...
      static discoverAltOrigin(e) {
        return Object(d.a)(this, void 0, void 0, function* () {
          const t = ji.getOneSignalProxyIframeUrls(e),
            i = [];
          for (const e of t) {
            const t = new _i(e);
            yield t.load(), i.push(t);
          }
          const n = yield ji.subscribedProxyFrameHosts(i);
          let o;
          yield ji.removeDuplicatedAltOriginSubscription(n),
      ...
      static getCanonicalSubscriptionUrls(e, t = y.a.getApiEnv()) {
        const i = ji.getWildcardLegacySubscriptionDomain(t),
          n = new URL(`https://${e.subdomain}.${i}`);
        if (t !== xi.a.Production) return [n];
      ...
      static getWildcardLegacySubscriptionDomain(e) {
        ...
        let i = 2;
        return e === xi.a.Staging && (i = 3), w.a.lastParts(t.host, ".", i);
      }
      static getOneSignalProxyIframeUrls(e) {
        const t = ji.getCanonicalSubscriptionUrls(e);
              ...
              if (!Bi.__initAlreadyCalled) {
                if (
                  ...
                  Bi.emitter.on(
                    ...
                    (Bi.proxyFrameHost = yield ji.discoverAltOrigin(Bi.config));
                }
    ...
    (Bi.VERSION = h.a.version()),
      ...
      (Bi.emitter = new Oe.a()),
      (Bi.cache = {}),
      (Bi.SERVICE_WORKER_UPDATER_PATH = "OneSignalSDKUpdaterWorker.js"),
      (Bi.SERVICE_WORKER_PATH = "OneSignalSDKWorker.js"),
      (Bi.SERVICE_WORKER_PARAM = { scope: "/" }),
      (Bi._LOGGING = !1),
      (Bi.LOGGING = !1),
      (Bi._usingNativePermissionHook = !1),
      (Bi._initCalled = !1),
