...
<head>
    ...
    <meta property="og:url" content="https://calcuttamedicalstore.in">
    <meta property="og:site_name" content="<?php echo $fset['title']; ?>">
    <meta property="og:image" content="https://calcuttamedicalstore.in/admin/<?php echo $fset['favicon']; ?>">
    ...
    <meta name="twitter:image" content="https://calcuttamedicalstore.in/admin/<?php echo $fset['favicon']; ?>">
    ...
    <script type="application/ld+json">
        {
            ...
            "@type": "Organization",
            "url": "http://calcuttamedicalstore.in",
            "name": "<?php echo $fset['title']; ?>",
            "logo": "https://calcuttamedicalstore.in/admin/<?php echo $fset['favicon']; ?>",
            "sameAs": [
...
<body style="margin: 0; background-image: url('admin/website/bg.jpg'); background-size: contain;">
    ...
    <div class="float">
        <a href="https://api.whatsapp.com/send?phone=<?php echo $fset['callsupport']; ?>" target="_blank">
                ...
                <div _ngcontent-sc69="" class="landing-page">
                    <div _ngcontent-sc69="">
                        ...
                        <div _ngcontent-sc69="" class="section-landing bg-f txt-c">
                            <div _ngcontent-sc69="">
                                <p _ngcontent-sc69="" translate="" class="news__headline h1 color-black margin-t-xl">"Reinvent the pharmacy Experience"<br /><img src="https://razorpay.com/assets/upi-autopay/logo-mobile.png" width="300px" />
                                </p>
