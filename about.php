  ...
  <div class="container">
    <div class="row mb-5">
      <div class="col-md-6">
        <div class="block-16">
          <figure>
            <img src="images/xbg_1.jpg.pagespeed.ic.XF59LUZb9G.jpg" alt="Image placeholder" class="img-fluid rounded">
    ...
    <div class="row">
        ...
        <div class="block-38 text-center">
          <div class="block-38-img">
            <div class="block-38-header">
              <img src="images/xperson_1.jpg.pagespeed.ic.yYek0ClmEN.jpg" alt="Image placeholder" class="mb-4">
      ...
      <div class="col-md-6 col-lg-6 mb-5">
        <div class="block-38 text-center">
          <div class="block-38-img">
            <div class="block-38-header">
              <img src="images/xperson_2.jpg.pagespeed.ic.5kkGTds6OX.jpg" alt="Image placeholder" class="mb-4">
      ...
      <div class="col-md-6 col-lg-6 mb-5">
        <div class="block-38 text-center">
          <div class="block-38-img">
            <div class="block-38-header">
              <img src="images/xperson_3.jpg.pagespeed.ic.NWdJNPr6_S.jpg" alt="Image placeholder" class="mb-4">
      ...
      <div class="col-md-6 col-lg-6 mb-5">
        <div class="block-38 text-center">
          <div class="block-38-img">
            <div class="block-38-header">
              <img src="images/xperson_4.jpg.pagespeed.ic.walfSW8PsV.jpg" alt="Image placeholder" class="mb-4">
